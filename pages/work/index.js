      ...
      <div className={styles.work}>
        <div className={styles.header}>
          ...
          >
            ...
            <h2 className={styles.h2}>All Works</h2>
            <svg
              width="16"
              height="40"
              viewBox="0 0 8 20"
        ...
        >
            ...
            <div className={styles.singledetail}>
              ...
              <div class={styles.buttonwrap}>
                <button
                  ...
                  onClick={() =>
                    window.open(
                      "https://github.com/parteek2813/Swiggy-ReactJs",
                      "_blank"
                    )
                  }
                >
          ...
          <div className={`${styles.single} ${styles.reverse}`}>
            ...
            <div className={styles.singledetail}>
              ...
              <p className={styles.p}>
                <span className={styles.span}>About:</span> A Digital Web3
                Platform For Tokenizing Company Shares/Stocks. These Assets Can
                Be Fungible Or Non-Fungible <br />
                <br />
                <span className={styles.span}>Tech Stack:</span> Javascript,
                SCSS, Typescript and others
              </p>
          ...
          <div className={styles.single}>
            ...
            <div className={styles.singledetail}>
              ...
              <p className={styles.p}>
                <span className={styles.span}>About:</span> This project is
                based on youtube clone implementing all the required
                functionalities needed for user <br />
                <br />
                <span className={styles.span}>Tech Stack:</span> React.js,
                Youtube-API, Redux, Jest for Testing , HTML, CSS, BrowserList
                for Compatiability, Web-vitals
              </p>
              ...
              <div class={styles.buttonwrap}>
                <button
                  ...
                  onClick={() =>
                    window.open(
                      "https://github.com/parteek2813/youtube-ReactJs",
                      "_blank"
                    )
                  }
                >
          ...
          <div className={`${styles.single} ${styles.reverse}`}>
            ...
            <div className={styles.singledetail}>
              ...
              <p className={styles.p}>
                <span className={styles.span}>About:</span> It is an alphabet
                guessing game where user can play and with each wrong guess,
                hangman will be approaching the dead end. <br />
                <br />
                <span className={styles.span}>Tech Stack:</span> React, Node,
                Express, Axios, MongoDB, Mongoose
              </p>
              ...
              <div class={styles.buttonwrap}>
                <button
                  ...
                  onClick={() =>
                    window.open(
                      "https://github.com/parteek2813/React-hangman-with-backend-logic",
                      "_blank"
                    )
                  }
                >
          ...
          <div className={styles.single}>
            ...
            <div className={styles.singledetail}>
              ...
              <p className={styles.p}>
                <span className={styles.span}>About:</span> Tunespot allows
                users to discover and listen to music from various genres and
                artists and add favorites songs. <br />
                <br />
                <span className={styles.span}>Tech Stack:</span> HTML, CSS ,
                Bootstrap, ReactJs, React-Router-dom, Typescript, Keyclock.
              </p>
              <div className={styles.buttonwrap}>
                <button
                  ...
                  onClick={() =>
                    window.open(
                      "https://github.com/parteek2813/Tunespot-ReactJs",
                      "_blank"
                    )
                  }
                >
          ...
          <div className={`${styles.single} ${styles.reverse}`}>
            ...
            <div className={styles.singledetail}>
              ...
              <p className={styles.p}>
                <span className={styles.span}>About:</span> A real-time chat
                application built using React.js and Firebase enabling users to
                communicate through text messages and also provides voice chat
                functionality.
                <br />
                <br />
                <span className={styles.span}>Tech Stack:</span> React,
                Firebase, Material UI, WebRTC
              </p>
              ...
              <div class={styles.buttonwrap}>
                <button
                  ...
                  onClick={() =>
                    window.open(
                      "https://github.com/parteek2813/Flamify-Reactjs",
                      "_blank"
                    )
                  }
                >
